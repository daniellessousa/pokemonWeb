...
export function Wave() {
  return (
    <div className="absolute bottom-0 left-0 w-full h-30 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full animate-wave-reverse delay-300">
        <svg
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
          className="absolute w-full h-full transform rotate-180"
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full animate-wave-fast delay-300">
        <svg
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
          className="absolute w-full h-full transform rotate-180"
